...
'''
        ...
        per=round(totalMarks/(100*totalSub)*100,2)
        print("*******************************************************************")
        print(f"TOTAL        {100*totalSub}            {40*totalSub}                {totalMarks}")
        print(f"Result: {self.result}                                     Percentage: {"  --  " if self.result=="Fail" else per} %")
        print(f"Grade : {self.getGrad(per)}")
